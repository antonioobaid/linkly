...
export default function OtherProfilePage() {
  ...
  const handleSendMessage = async () => {
    ...
    try {
      const res = await fetch(`${API_URL}/api/chats`, {
        ...
        body: JSON.stringify({ user1_id: currentUser.id, user2_id: profile.id }),
      });
  ...
  const goToProfile = (userId: string) => {
    if (userId === currentUser?.id) router.push("/profile");
  ...
  return (
    <>
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 lg:pl-56 md:pl-20 pt-16 sm:pt-16 md:pt-10 lg:pt-8 px-4 pb-20">
        <div className="max-w-4xl mx-auto">
          {/* Back button – mobile */}
          <div className="flex items-center mb-4 md:hidden">
            <button
